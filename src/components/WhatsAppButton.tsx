        ...
        <Tooltip delayDuration={300}>
          <TooltipTrigger asChild>
            <motion.a
              ...
              whileTap={{ scale: 0.9 }}
              className="relative flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-[#25D366] to-[#128C7E] text-white shadow-[0_8px_32px_rgba(37,211,102,0.3)] backdrop-blur-md border border-white/20 transition-all duration-300 hover:shadow-[0_0_40px_rgba(37,211,102,0.6)]"
            ...
            >
              ...
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
                className="relative z-10 h-8 w-8 drop-shadow-md"
